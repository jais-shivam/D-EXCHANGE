...
contract("Exchange", ([deployer, feeAccount, user1, user2]) => {
  ...
  beforeEach(async () => {
    ...
    // Deploy Exchanghe
    exchange = await Exchange.new(feeAccount, feePercent); //Fetch Exchange smart contract from BChain
  ...
  describe("deployment", () => {
    ...
    it("tracks the fee percent", async () => {
      ...
      describe('Deposit Ether',()=>{
          ...
          it('Emit a Deposit ether event', async ()=>{
              // console.log(result.logs[0]);
              const log=result.logs[0];
              log.event.should.eq('Deposit');
              const event= log.args;
              event.token.should.eq(ETHER_ADDRESS,'token address is correct');
              event.user.should.eq(user1,' user1 is correct');
      ...
      describe('withdrawing Ether', async ()=>{
          ...
          describe('failure',async ()=>{
            it('rejects withdraw from insufficient balance', async ()=>{
      ...
      describe('withdrawing token funds', async ()=>{
          let amount;
          let result;
          ...
          describe('failure',async ()=>{
            ...
            it('fails for insufficient balance ', async ()=>{
              // Attempt to deposit tokens without depositing any first.
